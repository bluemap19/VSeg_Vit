...
def get_args_parser():
    ...
    parser.add_argument('--epochs', default=60, type=int, help='Number of epochs of training.')
...
def train_dino(args):
    ...
    dataset = dataloader_ele_DINO(path=r'/root/autodl-tmp/data/target_stage1_small')
